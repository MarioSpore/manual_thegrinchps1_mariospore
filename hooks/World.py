...
def before_create_regions(world: World, multiworld: MultiWorld, player: int):
    ...
    # if world.options.missions.value == False and world.options.blueprintsanity.value == False and world.options.heartsanity.value == False and world.options.supadow.value == False and world.options.squash_all_gifts_missions.value == False and world.options.visitsanity.value == False:
